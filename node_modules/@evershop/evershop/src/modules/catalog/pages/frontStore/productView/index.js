...
module.exports = async (request, response, delegate, next) => {
  try {
    const query = select([
      'product.amazon_url', // Include the amazon_url column
      'product.*',          // Include all other columns from the product table
      'product_description.*', // Include all columns from product_description table
      'product_inventory.*' // Include all columns from product_inventory table
    ]);
    query
      .from('product')
