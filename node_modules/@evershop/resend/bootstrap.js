  ...
  const resendConfig = {
    ...
    events: {
      order_placed: {
        ...
        enabled: true,
        templatePath: "/config/emails/order_confirmation.html" // This is the path to the email template. Starting from the root of the project.
      },
      reset_password: {
        subject: 'Reset Password',
        enabled: true,
        templatePath: "/config/emails/reset_password.html" // This is the path to the email template. Starting from the root of the project.
      },
      customer_registered: {
